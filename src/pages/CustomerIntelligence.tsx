        ...
        >
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={(() => {
              ...
              <YAxis stroke={isDark ? '#9ca3af' : '#6b7280'} label={{ value: 'Number of Endpoints', angle: -90, position: 'insideLeft', offset: 20, style: { textAnchor: 'middle', fill: isDark ? '#9ca3af' : '#6b7280' } }} />
              <Tooltip
                contentStyle={{
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={(() => {
              ...
              <CartesianGrid strokeDasharray="3 3" stroke={isDark ? '#374151' : '#e5e7eb'} />
              <XAxis dataKey="category" stroke={isDark ? '#9ca3af' : '#6b7280'} />
              <YAxis stroke={isDark ? '#9ca3af' : '#6b7280'} label={{ value: 'Number of Servers', angle: -90, position: 'insideLeft', offset: 20, style: { textAnchor: 'middle', fill: isDark ? '#9ca3af' : '#6b7280' } }} />
              <Tooltip
                contentStyle={{
                  backgroundColor: isDark ? '#1e293b' : '#ffffff',
                  border: `1px solid ${isDark ? '#475569' : '#e5e7eb'}`,
