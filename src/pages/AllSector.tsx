            ...
            <table className={`w-full border-collapse ${isDark ? 'text-text-primary-dark' : 'text-text-primary-light'}`}>
              <thead className="sticky top-0 z-10">
                <tr className={`border-b-2 ${isDark ? 'border-navy-light' : 'border-gray-300'}`}>
                  <th className={`px-1 py-0 text-center font-bold ${isDark ? 'bg-gray-300 text-gray-900' : 'bg-gray-200 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`} style={{ width: '60px', maxWidth: '60px' }}>
                    S.No.
                  </th>
                  <th colSpan={6} className={`px-1 py-0 text-center font-bold ${isDark ? 'bg-orange-200 text-gray-900' : 'bg-orange-100 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`}>
                    CUSTOMER INFORMATION
                  </th>
                  <th colSpan={6} className={`px-1 py-0 text-center font-bold ${isDark ? 'bg-cyan-200 text-gray-900' : 'bg-cyan-100 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`}>
                    CONTACT DETAILS
                  </th>
                  {activeProposition === 'proposition1' && (
                    <th colSpan={3} className={`px-1 py-0 text-center font-bold ${isDark ? 'bg-purple-200 text-gray-900' : 'bg-purple-100 text-gray-900'}`}>
                      Current IT Infrastructure Landscape
                    </th>
                  )}
                  {activeProposition === 'proposition2' && (
                    <>
                      <th colSpan={6} className={`px-1 py-0 text-center font-bold ${isDark ? 'bg-purple-200 text-gray-900' : 'bg-purple-100 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`}>
                        Current IT Infrastructure Landscape
                      </th>
                      <th colSpan={3} className={`px-1 py-0 text-center font-bold ${isDark ? 'bg-pink-200 text-gray-900' : 'bg-pink-100 text-gray-900'}`}>
                  ...
                  {activeProposition === 'proposition3' && (
                    <>
                      ...
                      <th colSpan={6} className={`px-1 py-0 text-center font-bold ${isDark ? 'bg-pink-200 text-gray-900' : 'bg-pink-100 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`}>
                        Current IT Support Setup
                      </th>
                      <th colSpan={5} className={`px-1 py-0 text-center font-bold ${isDark ? 'bg-yellow-200 text-gray-900' : 'bg-yellow-100 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`}>
                        Financial & Commercial Datapoints
                      </th>
                      <th colSpan={2} className={`px-1 py-0 text-center font-bold ${isDark ? 'bg-green-200 text-gray-900' : 'bg-green-100 text-gray-900'}`}>
                        CMI Insights
                      </th>
                    </>
                  )}
                ...
                <tr className={`border-b-2 ${isDark ? 'border-navy-light' : 'border-gray-300'}`}>
                  <th className={`px-1 py-0 text-center font-semibold ${isDark ? 'bg-gray-200 text-gray-900' : 'bg-gray-100 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`} style={{ width: '60px', maxWidth: '60px' }}>
                    S.No.
                  </th>
                  <th className={`px-1 py-0 text-center font-semibold ${isDark ? 'bg-orange-100 text-gray-900' : 'bg-orange-50 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`}>
                    Customer Name
                  </th>
                  <th className={`px-1 py-0 text-center font-semibold ${isDark ? 'bg-orange-100 text-gray-900' : 'bg-orange-50 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`}>
                    Company Name
                  ...
                  <th className={`px-1 py-0 text-center font-semibold ${isDark ? 'bg-cyan-100 text-gray-900' : 'bg-cyan-50 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`}>
                    Key Contact Person
                  </th>
                  <th className={`px-1 py-0 text-center font-semibold ${isDark ? 'bg-cyan-100 text-gray-900' : 'bg-cyan-50 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`}>
                    Designation / Role
                  ...
                  {activeProposition === 'proposition1' && (
                    <>
                      ...
                      <th className={`px-1 py-0 text-center font-semibold ${isDark ? 'bg-purple-100 text-gray-900' : 'bg-purple-50 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`} style={{ width: '120px', maxWidth: '120px', whiteSpace: 'normal', lineHeight: '1.1', wordWrap: 'break-word' }}>
                  ...
                  {activeProposition === 'proposition3' && (
                    <>
                      ...
                      <th className={`px-1 py-0 text-center font-semibold ${isDark ? 'bg-green-100 text-gray-900' : 'bg-green-50 text-gray-900'} border-r ${isDark ? 'border-gray-400' : 'border-gray-300'}`} style={{ width: '150px', maxWidth: '150px', whiteSpace: 'normal', lineHeight: '1.1', wordWrap: 'break-word' }}>
                        Customer Benchmarking Summary
                      </th>
                      <th className={`px-1 py-0 text-center font-semibold ${isDark ? 'bg-green-100 text-gray-900' : 'bg-green-50 text-gray-900'}`} style={{ width: '150px', maxWidth: '150px', whiteSpace: 'normal', lineHeight: '1.1', wordWrap: 'break-word' }}>
                ...
                {currentData.length === 0 ? (
                  ...
                  currentData.map((row, index) => (
                    <tr key={index} className={`border-b ${isDark ? 'border-navy-light hover:bg-navy-light/50' : 'border-gray-200 hover:bg-gray-50'}`}>
                      <td className={`px-1 py-0 text-center border-r ${isDark ? 'text-text-primary-dark border-gray-400' : 'text-text-primary-light border-gray-300'}`}>
                        {index + 1}
                      </td>
                      <td className={`px-1 py-0 border-r ${isDark ? 'text-text-primary-dark border-gray-400' : 'text-text-primary-light border-gray-300'}`}>
                        {row.customerName}
                      </td>
                      <td className={`px-1 py-0 border-r ${isDark ? 'text-text-primary-dark border-gray-400' : 'text-text-primary-light border-gray-300'}`}>
                        {row.companyName}
                      ...
                      {activeProposition === 'proposition1' && (
                        <>
                          ...
                          <td className={`px-1 py-0 ${isDark ? 'text-text-primary-dark' : 'text-text-primary-light'}`}>
                            {row.cloudFootprint}
                          </td>
                        </>
                      )}
